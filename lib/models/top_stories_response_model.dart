...
class TopStoriesResponseModel {
  ...
  TopStoriesResponseModel({this.status, this.copyright, this.section, this.lastUpdated, this.numResults, this.results});

  TopStoriesResponseModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
